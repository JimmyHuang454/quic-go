...
require (
	github.com/JimmyHuang454/qtls-go1-20-JLS v0.0.0-20230907013506-e0f84291d2e9
...
require (
	github.com/JimmyHuang454/JLS-go v0.0.0-20230827171257-beaf6e558bc8 // indirect
